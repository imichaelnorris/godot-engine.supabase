...
func _connect_signals() -> void:
	_ws_client.connect("connection_closed", _closed)
	_ws_client.connect("connection_error", _error)
	_ws_client.connect("connection_established", _connected)
	_ws_client.connect("data_received", _on_data)
	_heartbeat_timer.connect("timeout", _on_timeout)

func _disconnect_signals() -> void:
	_ws_client.disconnect("connection_closed", _closed)
	_ws_client.disconnect("connection_error", _error)
	_ws_client.disconnect("connection_established", _connected)
	_ws_client.disconnect("data_received", _on_data)
	_heartbeat_timer.disconnect("timeout", _on_timeout)
